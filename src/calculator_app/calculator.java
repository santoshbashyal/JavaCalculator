...
public class calculator extends javax.swing.JFrame {
    ...
    public calculator() {
        initComponents();
        jRadioButton2.setEnabled(false); // ON DISABLE
    }
    ...
    public void enable()
    {
        ...
        jRadioButton2.setEnabled(false); //ON DISABLE
        jRadioButton1.setEnabled(true); //OFF ENABLE
...
public void disable()
{
    ...
    jRadioButton2.setEnabled(true); //on enable
    jRadioButton1.setEnabled(false); //off disable
